...
parser.add_argument('-ds', type=str, required=True, metavar='DOAMINSEEDS', default=_default['domainSeeds'],
                   dest='domainSeeds', help='Specify the begin domain feeds file path, Default: %s ' %                    _default['domainSeeds'])

parser.add_argument('-m', type=positiveInt, required=True, metavar='MAXDOMAINSEEDS', dest='maxDomainSeeds',
                   help='Specify the max domain seeds size which will be crawled')
...
parser.add_argument('-t','--thread', type=positiveInt, metavar='NUM', default=_default['threadNum'], dest='threadNum',
